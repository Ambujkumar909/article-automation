...
const App = () => {
  ...
  return (
    ...
    />
          ...
          >
            ...
            >
              <h1 className="text-[14vw] md:text-[12vw] font-black leading-[0.8] tracking-tighter mb-12">
                THINK <br /> 
                <span className="font-serif italic font-light text-[#2563eb]">Better.</span>
              </h1>
              <p className="max-w-md mx-auto text-lg text-black/50 mb-12 font-medium">
      ...
      {/* 4. COMPARISON MODAL (DUAL INDEPENDENT SCROLL) */}
      <AnimatePresence>
        {selected && (
          <motion.div 
            initial={{ y: '100%' }}
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-20 relative">
              <button 
                ...
                className="fixed top-10 right-10 z-[70] bg-[#1A1A1A] text-white p-5 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition"
              >
                <X size={24} />
              </button>
              ...
              <header className="max-w-4xl mb-16">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="inline-flex items-center gap-3 bg-black/5 px-8 py-4 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-black/10 transition"
                >
                  <Globe size={16}/> Source Integrity Link
                </a>
              </header>

              {/* DUAL SCROLL COMPARISON GRID */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch h-[75vh] mb-10">
                
                {/* LEFT: THE ORIGINAL ARCHIVE (Independent Scroll) */}
                <div className="flex flex-col h-full bg-black/[0.03] rounded-[3rem] p-8 md:p-12 border border-black/5">
                ...
                {/* RIGHT: THE REFINED EDITORIAL (Independent Scroll) */}
                <div className="flex flex-col h-full bg-white rounded-[4rem] p-8 md:p-16 shadow-[0_80px_120px_-30px_rgba(0,0,0,0.08)] border border-black/5">
                  <div className="flex items-center gap-2 text-[#2563eb] text-[10px] font-black uppercase tracking-[0.2em] mb-12">
                    <Sparkles size={16} className="animate-pulse" /> Refined Intelligence
                  </div>
                  
                  <div className="flex-1 overflow-y-auto pr-6 custom-scrollbar">
                    <div className="prose prose-lg md:prose-xl prose-slate max-w-none 
                      prose-headings:font-serif prose-headings:font-bold prose-headings:text-[#1A1A1A] prose-headings:tracking-tighter
                      prose-p:text-slate-700 prose-p:leading-[1.8]
                      prose-li:text-slate-700 prose-strong:text-[#1A1A1A]
                      prose-ul:list-disc prose-ol:list-decimal
                      prose-blockquote:border-[#2563eb] prose-blockquote:bg-blue-50/50">
  ...
  <div className="max-w-7xl mx-auto px-8">
    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div className="flex flex-col items-center md:items-start gap-1">
        <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#2563eb] mb-1">
          Developed By
        </h4>
        ...
        <a 
          href="mailto:ambujkr8@gmail.com" 
          className="text-xs text-black/40 hover:text-[#2563eb] transition-all font-medium tracking-wide"
        >
          ambujkr8@gmail.com
        </a>
      </div>
